...
export default function CouponEdit({ coupon, products }: { coupon: Coupon; products: Product[] }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        claim_limit: coupon.claim_limit?.toString() ?? '',
                ...
                <div className="mx-auto max-w-2xl">
                    <div className="mb-6 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Update voucher details</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                            ...
                            >
                                ...
                                {processing ? 'Saving...' : 'Update Voucher'}
                            </button>
                        </div>
                    </form>
                </div>
